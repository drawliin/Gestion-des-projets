...
class CreateChantiersDeTravailTable extends Migration
{
    public function up()
    {
        Schema::create('chantiers_de_travail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('chantiers_de_travail');
    }
}
